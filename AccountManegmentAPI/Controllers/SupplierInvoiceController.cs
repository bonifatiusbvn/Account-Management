...
namespace AccountManagement.API.Controllers
{
    ...
    public class SupplierInvoiceController : ControllerBase
    {
        ...
        public async Task<IActionResult> GetInvoiceDetailsById(DataTableRequstModel PayOutReport)
        {
        ...
        public async Task<IActionResult> GetPayoutInvoiceDetailsPdfReport(InvoiceReportModel invoiceReport)
        {
